...
export default function GeographyMain() {
  const [selectedMapStyle, setSelectedMapStyle] = useState<string>('streets-v12');
          ...
          <div className="container h-full py-3">
            <div className="grid h-full items-stretch gap-6 md:grid-cols-[1fr_200px]">
              <div className="hidden flex-col space-y-4 sm:flex md:order-2">
                ...
                <RadioGroup defaultValue={selectedMapStyle} onValueChange={(value) => setSelectedMapStyle(value)}>
                  {["streets-v12", "light-v11", "dark-v11", "outdoors-v12"].map((item, index) => {
                    return (
