...
function NavBar() {
  const navLinks: NavigationItem[] = [{ title: "English", path: "english/main" }, { title: "Music", path: "music" }, { title: "About", path: "about" }, { title: "Project", path: "#project" }, { title: "Contact", path: "contact" }]
