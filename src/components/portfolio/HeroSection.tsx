			...
			<div className="grid grid-cols-1 sm:grid-cols-12">
				<div className="col-span-7 place-self-center text-center sm:text-left">
					...
					<p className="text-[#ADB7BE] text-base sm:text-large mb-6 lg:text-xl">
						Lorem ipsum do lor sit amet consectetur adipisicing elit. Quisqu vo
						luptatum.
					</p>
					<div>
						<button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-green-700 via-green-500 to-green-400  hover: bg-slate-200 text-white">
							Hire Me
						</button>
