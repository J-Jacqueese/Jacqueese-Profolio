        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;This application is designed for visualizing the movement paths of typhoons. It utilizes the Next.js framework and the Mapbox plugin for displaying maps. You can experience the typhoon visualization by logging into the system.&rdquo;
              </p>
